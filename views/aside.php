...
<div class="col-lg-3 col-md-3 col-sm-12">
        	...
        	echo'
              <li>
                <div class="media"><a class="media-left" href=""><img width = "200px" height="150px" src="'.root.'assets/images/'.$last['foto'].'" width="100px" alt=""></a>
                  <div class="media-body"><a class="catg_title" href="'.root.'artikel/view/'.$last['id'].'/'.$last['link'].'">'.$last['artikel_title'].'</a></div>
                </div>
              </li>
               ';
        }
        echo'
                ...
                ';
                  ...
                  <li>
                    ...
                    <div class="media"><a class="media-left" href="pages/single_page.html"><img width = "200px" height="150px" src="'.root.'assets/images/'.$top['foto'].'" alt=""></a>
                      <div class="media-body"><a class="catg_title" href="'.root.'artikel/view/'.$top['id'].'/'.$last['link'].'">'.$top['artikel_title'].'</a></div>
                    </div>
          ...
          <div class="single_widget">
            <h2>Links</h2>
            <ul>
              <li><a href="'.adm.'admin">Log in</a></li>
